...
console.log("- You have given the 3 round to guess the computer genetrated number.");
console.log("- In which you have to select number from 1-20.");
console.log("- In order to win the game,you have to guess the right number atleast once.");
...
if (!result) {
    console.log("You fail to guess the number.\nCorrect Answer is:", computerGenerated);
}
